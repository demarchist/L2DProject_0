-- Original: https://raw.github.com/markandgo/simple-transform/master/affine.lua (Affine v1.01b)
local affine = {}
local mt


local __call = function ( self, x, y )
	return x * self[1][1] + y * self[1][2] + self[1][3],
	       x * self[2][1] + y * self[2][2] + self[2][3]
end
...
mt = {__call = __call, __mul = __mul, __pow = __pow, __div = __div, __tostring = __tostring}
